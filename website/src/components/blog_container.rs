...
pub fn BlogContainer(markdown: String) -> impl IntoView {
    ...
    view! {
        <article
            ...
            class="max-w-full bg-transparent xl:max-w-5xl prose-slate prose prose-sm prose-a:no-underline prose-a:link-info prose-code:select-all [&>pre]:select-all [&>pre]:mockup-code [&>pre]:bg-netural [&>pre]:text-neutral-content [&>a]:link-info sm:prose-base md:prose-lg lg:prose-xl xl:prose-2xl"
        >
